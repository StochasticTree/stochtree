...
bart_fit_cpp <- function(sampler_cfg, mean_forest_cfg, variance_forest_cfg, X_train_r, y_train_r, X_test_r, feature_types_r, weights_r) {
  .Call(`_stochtree_bart_fit_cpp`, sampler_cfg, mean_forest_cfg, variance_forest_cfg, X_train_r, y_train_r, X_test_r, feature_types_r, weights_r)
}
