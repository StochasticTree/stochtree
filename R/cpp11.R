...
bart_sample_cpp <- function(samples, X_train, y_train, X_test, n_train, n_test, p, basis_train, basis_test, basis_dim, obs_weights_train, obs_weights_test, rfx_group_ids_train, rfx_group_ids_test, rfx_basis_train, rfx_basis_test, rfx_num_groups, rfx_basis_dim, num_gfr, num_burnin, keep_every, num_mcmc, num_chains, warmstart_samples, warmstart_sample_num, config_input) {
  .Call(`_stochtree_bart_sample_cpp`, samples, X_train, y_train, X_test, n_train, n_test, p, basis_train, basis_test, basis_dim, obs_weights_train, obs_weights_test, rfx_group_ids_train, rfx_group_ids_test, rfx_basis_train, rfx_basis_test, rfx_num_groups, rfx_basis_dim, num_gfr, num_burnin, keep_every, num_mcmc, num_chains, warmstart_samples, warmstart_sample_num, config_input)
}

bart_continue_sample_cpp <- function(samples, X_train, y_train, X_test, n_train, n_test, p, basis_train, basis_test, basis_dim, obs_weights_train, obs_weights_test, rfx_group_ids_train, rfx_group_ids_test, rfx_basis_train, rfx_basis_test, rfx_num_groups, rfx_basis_dim, num_gfr, num_burnin, keep_every, num_mcmc, keep_gfr, rng_state_in, override_seed, config_input) {
  .Call(`_stochtree_bart_continue_sample_cpp`, samples, X_train, y_train, X_test, n_train, n_test, p, basis_train, basis_test, basis_dim, obs_weights_train, obs_weights_test, rfx_group_ids_train, rfx_group_ids_test, rfx_basis_train, rfx_basis_test, rfx_num_groups, rfx_basis_dim, num_gfr, num_burnin, keep_every, num_mcmc, keep_gfr, rng_state_in, override_seed, config_input)
}

bart_predict_cpp <- function(bart_samples_ptr, bart_model_metadata, X, leaf_basis, n, p, num_basis, obs_weights, rfx_group_ids, rfx_basis, rfx_num_groups, rfx_basis_dim, posterior, scale, predict_y_hat, predict_mean_forest, predict_variance_forest, predict_random_effects) {
...
bcf_predict_cpp <- function(bcf_samples_ptr, bcf_model_metadata, X, Z, n, p, treatment_dim, obs_weights, rfx_group_ids, rfx_basis, rfx_num_groups, rfx_basis_dim, posterior, scale, predict_y_hat, predict_mu_x, predict_tau_x, predict_prognostic_function, predict_cate, predict_conditional_variance, predict_random_effects) {
  .Call(`_stochtree_bcf_predict_cpp`, bcf_samples_ptr, bcf_model_metadata, X, Z, n, p, treatment_dim, obs_weights, rfx_group_ids, rfx_basis, rfx_num_groups, rfx_basis_dim, posterior, scale, predict_y_hat, predict_mu_x, predict_tau_x, predict_prognostic_function, predict_cate, predict_conditional_variance, predict_random_effects)
}
...
bart_samples_cpp <- function() {
  .Call(`_stochtree_bart_samples_cpp`)
}

bart_samples_from_json_cpp <- function(json) {
  .Call(`_stochtree_bart_samples_from_json_cpp`, json)
}

append_bart_samples_to_json_cpp <- function(samples, json) {
  invisible(.Call(`_stochtree_append_bart_samples_to_json_cpp`, samples, json))
}
...
bart_samples_has_yhat_train_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_has_yhat_train_cpp`, samples)
}

bart_samples_has_mean_forest_predictions_train_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_has_mean_forest_predictions_train_cpp`, samples)
}

bart_samples_has_variance_forest_predictions_train_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_has_variance_forest_predictions_train_cpp`, samples)
}

bart_samples_has_rfx_predictions_train_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_has_rfx_predictions_train_cpp`, samples)
}

bart_samples_has_yhat_test_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_has_yhat_test_cpp`, samples)
}

bart_samples_has_mean_forest_predictions_test_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_has_mean_forest_predictions_test_cpp`, samples)
}

bart_samples_has_variance_forest_predictions_test_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_has_variance_forest_predictions_test_cpp`, samples)
}

bart_samples_has_rfx_predictions_test_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_has_rfx_predictions_test_cpp`, samples)
}

bart_samples_has_cloglog_cutpoint_samples_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_has_cloglog_cutpoint_samples_cpp`, samples)
}

bart_samples_has_global_var_samples_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_has_global_var_samples_cpp`, samples)
}

bart_samples_has_leaf_scale_samples_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_has_leaf_scale_samples_cpp`, samples)
}
...
bart_samples_has_rfx_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_has_rfx_cpp`, samples)
}
...
bart_samples_mean_forest_predictions_train_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_mean_forest_predictions_train_cpp`, samples)
}

bart_samples_variance_forest_predictions_train_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_variance_forest_predictions_train_cpp`, samples)
}

bart_samples_rfx_predictions_train_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_rfx_predictions_train_cpp`, samples)
}

bart_samples_yhat_train_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_yhat_train_cpp`, samples)
}

bart_samples_mean_forest_predictions_test_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_mean_forest_predictions_test_cpp`, samples)
}

bart_samples_variance_forest_predictions_test_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_variance_forest_predictions_test_cpp`, samples)
}

bart_samples_rfx_predictions_test_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_rfx_predictions_test_cpp`, samples)
}

bart_samples_yhat_test_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_yhat_test_cpp`, samples)
}
...
bart_samples_cloglog_cutpoint_samples_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_cloglog_cutpoint_samples_cpp`, samples)
}
...
bart_samples_materialize_rfx_container_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_materialize_rfx_container_cpp`, samples)
}

bart_samples_materialize_rfx_label_mapper_cpp <- function(samples) {
  .Call(`_stochtree_bart_samples_materialize_rfx_label_mapper_cpp`, samples)
}
...
bcf_samples_cpp <- function() {
  .Call(`_stochtree_bcf_samples_cpp`)
}

bcf_samples_from_json_cpp <- function(json) {
  .Call(`_stochtree_bcf_samples_from_json_cpp`, json)
}

append_bcf_samples_to_json_cpp <- function(samples, json) {
  invisible(.Call(`_stochtree_append_bcf_samples_to_json_cpp`, samples, json))
}
...
bcf_samples_has_rfx_cpp <- function(samples) {
  .Call(`_stochtree_bcf_samples_has_rfx_cpp`, samples)
}
...
bcf_samples_yhat_train_cpp <- function(samples) {
  .Call(`_stochtree_bcf_samples_yhat_train_cpp`, samples)
}

bcf_samples_mu_forest_predictions_train_cpp <- function(samples) {
  .Call(`_stochtree_bcf_samples_mu_forest_predictions_train_cpp`, samples)
}

bcf_samples_tau_forest_predictions_train_cpp <- function(samples) {
  .Call(`_stochtree_bcf_samples_tau_forest_predictions_train_cpp`, samples)
}

bcf_samples_variance_forest_predictions_train_cpp <- function(samples) {
  .Call(`_stochtree_bcf_samples_variance_forest_predictions_train_cpp`, samples)
}

bcf_samples_rfx_predictions_train_cpp <- function(samples) {
  .Call(`_stochtree_bcf_samples_rfx_predictions_train_cpp`, samples)
}

bcf_samples_yhat_test_cpp <- function(samples) {
  .Call(`_stochtree_bcf_samples_yhat_test_cpp`, samples)
}

bcf_samples_mu_forest_predictions_test_cpp <- function(samples) {
  .Call(`_stochtree_bcf_samples_mu_forest_predictions_test_cpp`, samples)
}

bcf_samples_tau_forest_predictions_test_cpp <- function(samples) {
  .Call(`_stochtree_bcf_samples_tau_forest_predictions_test_cpp`, samples)
}

bcf_samples_variance_forest_predictions_test_cpp <- function(samples) {
  .Call(`_stochtree_bcf_samples_variance_forest_predictions_test_cpp`, samples)
}

bcf_samples_rfx_predictions_test_cpp <- function(samples) {
  .Call(`_stochtree_bcf_samples_rfx_predictions_test_cpp`, samples)
}
...
bcf_samples_materialize_rfx_container_cpp <- function(samples) {
  .Call(`_stochtree_bcf_samples_materialize_rfx_container_cpp`, samples)
}

bcf_samples_materialize_rfx_label_mapper_cpp <- function(samples) {
  .Call(`_stochtree_bcf_samples_materialize_rfx_label_mapper_cpp`, samples)
}
