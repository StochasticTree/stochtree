...
bart_sampler_fit_r_cpp <- function(X_train_r, y_train_r, X_test_r, weights_r, feature_types_r, basis_train_r, basis_test_r, rfx_group_ids_train_r, rfx_group_ids_test_r, rfx_basis_train_r, rfx_basis_test_r, num_trees, num_gfr, num_burnin, num_mcmc, num_chains, keep_every, keep_gfr, keep_burnin, alpha_mean, beta_mean, min_samples_leaf_mean, max_depth_mean, sample_sigma2_global, sample_sigma2_leaf, standardize, cutpoint_grid_size, a_global, b_global, a_leaf, b_leaf, sigma2_init, link_function_str, leaf_model_str, cloglog_num_categories, include_variance_forest, num_trees_variance, alpha_variance, beta_variance, min_samples_leaf_variance, max_depth_variance, a_forest, b_forest, variance_forest_leaf_init, rfx_model_spec_str, rfx_num_components, rfx_alpha_init, rfx_xi_init, rfx_sigma_alpha_init, rfx_sigma_xi_init, rfx_variance_prior_shape, rfx_variance_prior_scale, variable_weights_mean_r, variable_weights_variance_r, random_seed, num_threads) {
  .Call(`_stochtree_bart_sampler_fit_r_cpp`, X_train_r, y_train_r, X_test_r, weights_r, feature_types_r, basis_train_r, basis_test_r, rfx_group_ids_train_r, rfx_group_ids_test_r, rfx_basis_train_r, rfx_basis_test_r, num_trees, num_gfr, num_burnin, num_mcmc, num_chains, keep_every, keep_gfr, keep_burnin, alpha_mean, beta_mean, min_samples_leaf_mean, max_depth_mean, sample_sigma2_global, sample_sigma2_leaf, standardize, cutpoint_grid_size, a_global, b_global, a_leaf, b_leaf, sigma2_init, link_function_str, leaf_model_str, cloglog_num_categories, include_variance_forest, num_trees_variance, alpha_variance, beta_variance, min_samples_leaf_variance, max_depth_variance, a_forest, b_forest, variance_forest_leaf_init, rfx_model_spec_str, rfx_num_components, rfx_alpha_init, rfx_xi_init, rfx_sigma_alpha_init, rfx_sigma_xi_init, rfx_variance_prior_shape, rfx_variance_prior_scale, variable_weights_mean_r, variable_weights_variance_r, random_seed, num_threads)
}

bcf_sampler_fit_r_cpp <- function(X_train_r, y_train_r, Z_train_r, pi_hat_train_r, X_test_r, Z_test_r, pi_hat_test_r, weights_r, feature_types_r, num_gfr, num_burnin, num_mcmc, num_chains, keep_every, keep_gfr, keep_burnin, sample_sigma2_global, a_global, b_global, sigma2_init, num_trees_mu, alpha_mu, beta_mu, min_samples_leaf_mu, max_depth_mu, sample_sigma2_leaf_mu, a_leaf_mu, b_leaf_mu, leaf_scale_mu, variable_weights_mu_r, num_trees_tau, alpha_tau, beta_tau, min_samples_leaf_tau, max_depth_tau, sample_sigma2_leaf_tau, a_leaf_tau, b_leaf_tau, leaf_scale_tau, variable_weights_tau_r, sample_intercept, tau_0_prior_var, adaptive_coding, b0_init, b1_init, coding_prior_var, propensity_covariate, include_variance_forest, num_trees_variance, alpha_variance, beta_variance, min_samples_leaf_variance, max_depth_variance, a_forest, b_forest, variance_forest_leaf_init, standardize, random_seed, num_threads) {
  .Call(`_stochtree_bcf_sampler_fit_r_cpp`, X_train_r, y_train_r, Z_train_r, pi_hat_train_r, X_test_r, Z_test_r, pi_hat_test_r, weights_r, feature_types_r, num_gfr, num_burnin, num_mcmc, num_chains, keep_every, keep_gfr, keep_burnin, sample_sigma2_global, a_global, b_global, sigma2_init, num_trees_mu, alpha_mu, beta_mu, min_samples_leaf_mu, max_depth_mu, sample_sigma2_leaf_mu, a_leaf_mu, b_leaf_mu, leaf_scale_mu, variable_weights_mu_r, num_trees_tau, alpha_tau, beta_tau, min_samples_leaf_tau, max_depth_tau, sample_sigma2_leaf_tau, a_leaf_tau, b_leaf_tau, leaf_scale_tau, variable_weights_tau_r, sample_intercept, tau_0_prior_var, adaptive_coding, b0_init, b1_init, coding_prior_var, propensity_covariate, include_variance_forest, num_trees_variance, alpha_variance, beta_variance, min_samples_leaf_variance, max_depth_variance, a_forest, b_forest, variance_forest_leaf_init, standardize, random_seed, num_threads)
}
