...
bart_sample_cpp <- function(X_train, y_train, X_test, n_train, n_test, p, basis_train, basis_test, basis_dim, obs_weights_train, obs_weights_test, rfx_group_ids_train, rfx_group_ids_test, rfx_basis_train, rfx_basis_test, rfx_num_groups, rfx_basis_dim, num_gfr, num_burnin, keep_every, num_mcmc, num_chains, config_input) {
...
bart_predict_cpp <- function(bart_model_list, X, leaf_basis, n, p, num_basis, obs_weights, rfx_group_ids, rfx_basis, rfx_num_groups, rfx_basis_dim, posterior, scale, predict_y_hat, predict_mean_forest, predict_variance_forest, predict_random_effects) {
  .Call(`_stochtree_bart_predict_cpp`, bart_model_list, X, leaf_basis, n, p, num_basis, obs_weights, rfx_group_ids, rfx_basis, rfx_num_groups, rfx_basis_dim, posterior, scale, predict_y_hat, predict_mean_forest, predict_variance_forest, predict_random_effects)
}
...
bcf_predict_cpp <- function(bcf_model_list, X, Z, n, p, treatment_dim, obs_weights, rfx_group_ids, rfx_basis, rfx_num_groups, rfx_basis_dim, posterior, scale, predict_y_hat, predict_mu_x, predict_tau_x, predict_prognostic_function, predict_cate, predict_conditional_variance, predict_random_effects) {
  .Call(`_stochtree_bcf_predict_cpp`, bcf_model_list, X, Z, n, p, treatment_dim, obs_weights, rfx_group_ids, rfx_basis, rfx_num_groups, rfx_basis_dim, posterior, scale, predict_y_hat, predict_mu_x, predict_tau_x, predict_prognostic_function, predict_cate, predict_conditional_variance, predict_random_effects)
}
