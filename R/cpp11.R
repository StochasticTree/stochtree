...
bart_fit_cpp <- function(sampler_cfg, mean_forest_cfg, variance_forest_cfg, rfx_cfg, X_train_r, y_train_r, X_test_r, feature_types_r, weights_r, basis_train_r, basis_test_r, rfx_groups_train_r, rfx_basis_train_r, rfx_groups_test_r, rfx_basis_test_r) {
  .Call(`_stochtree_bart_fit_cpp`, sampler_cfg, mean_forest_cfg, variance_forest_cfg, rfx_cfg, X_train_r, y_train_r, X_test_r, feature_types_r, weights_r, basis_train_r, basis_test_r, rfx_groups_train_r, rfx_basis_train_r, rfx_groups_test_r, rfx_basis_test_r)
}

bart_result_num_samples_cpp <- function(ptr) {
  .Call(`_stochtree_bart_result_num_samples_cpp`, ptr)
}

bart_result_y_bar_cpp <- function(ptr) {
  .Call(`_stochtree_bart_result_y_bar_cpp`, ptr)
}

bart_result_y_std_cpp <- function(ptr) {
  .Call(`_stochtree_bart_result_y_std_cpp`, ptr)
}

bart_result_y_hat_train_cpp <- function(ptr) {
  .Call(`_stochtree_bart_result_y_hat_train_cpp`, ptr)
}

bart_result_y_hat_test_cpp <- function(ptr) {
  .Call(`_stochtree_bart_result_y_hat_test_cpp`, ptr)
}

bart_result_sigma2_global_samples_cpp <- function(ptr) {
  .Call(`_stochtree_bart_result_sigma2_global_samples_cpp`, ptr)
}

bart_result_leaf_scale_samples_cpp <- function(ptr) {
  .Call(`_stochtree_bart_result_leaf_scale_samples_cpp`, ptr)
}

bart_result_cloglog_cutpoint_samples_cpp <- function(ptr) {
  .Call(`_stochtree_bart_result_cloglog_cutpoint_samples_cpp`, ptr)
}

bart_result_steal_forest_samples_cpp <- function(ptr) {
  .Call(`_stochtree_bart_result_steal_forest_samples_cpp`, ptr)
}

bart_result_has_variance_forest_cpp <- function(ptr) {
  .Call(`_stochtree_bart_result_has_variance_forest_cpp`, ptr)
}

bart_result_sigma2_x_hat_train_cpp <- function(ptr) {
  .Call(`_stochtree_bart_result_sigma2_x_hat_train_cpp`, ptr)
}

bart_result_sigma2_x_hat_test_cpp <- function(ptr) {
  .Call(`_stochtree_bart_result_sigma2_x_hat_test_cpp`, ptr)
}

bart_result_steal_variance_forest_samples_cpp <- function(ptr) {
  .Call(`_stochtree_bart_result_steal_variance_forest_samples_cpp`, ptr)
}

bart_result_has_rfx_cpp <- function(ptr) {
  .Call(`_stochtree_bart_result_has_rfx_cpp`, ptr)
}

bart_result_rfx_num_groups_cpp <- function(ptr) {
  .Call(`_stochtree_bart_result_rfx_num_groups_cpp`, ptr)
}

bart_result_rfx_num_components_cpp <- function(ptr) {
  .Call(`_stochtree_bart_result_rfx_num_components_cpp`, ptr)
}

bart_result_rfx_group_ids_cpp <- function(ptr) {
  .Call(`_stochtree_bart_result_rfx_group_ids_cpp`, ptr)
}

bart_result_steal_rfx_container_cpp <- function(ptr) {
  .Call(`_stochtree_bart_result_steal_rfx_container_cpp`, ptr)
}
...
rfx_label_mapper_from_group_ids_cpp <- function(group_ids) {
  .Call(`_stochtree_rfx_label_mapper_from_group_ids_cpp`, group_ids)
}
