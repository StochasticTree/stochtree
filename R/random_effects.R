...
RandomEffectSamples <- R6::R6Class(
  ...
  public = list(
    ...
    load_in_session = function(
      ...
      self$label_mapper_ptr <- rfx_label_mapper_cpp(
        random_effects_tracker$rfx_tracker_ptr
      )
      self$training_group_ids <- rfx_tracker_get_unique_group_ids_cpp(
        random_effects_tracker$rfx_tracker_ptr
      )
    },
    ...
    load_from_json = function(
      ...
      self$rfx_container_ptr <- rfx_container_from_json_cpp(
        json_object$json_ptr,
        json_rfx_container_label
      )
      self$label_mapper_ptr <- rfx_label_mapper_from_json_cpp(
        json_object$json_ptr,
        json_rfx_mapper_label
      )
      self$training_group_ids <- rfx_group_ids_from_json_cpp(
        json_object$json_ptr,
        json_rfx_groupids_label
      )
    },
    ...
    #' @param json_rfx_groupids_label Label referring to a particular set of rfx group IDs (i.e. "random_effect_groupids_0") in the overall json hierarchy
    #' @return None
    append_from_json = function(
      json_object,
      json_rfx_container_label,
      json_rfx_mapper_label,
      json_rfx_groupids_label
    ) {
      rfx_container_append_from_json_cpp(
        self$rfx_container_ptr,
        json_object$json_ptr,
        json_rfx_container_label
      )
    },
    ...
    #' @param json_rfx_groupids_label Label referring to a particular set of rfx group IDs (i.e. "random_effect_groupids_0") in the overall json hierarchy
    #' @return A new `RandomEffectSamples` object.
    load_from_json_string = function(
      json_string,
      json_rfx_container_label,
      json_rfx_mapper_label,
      json_rfx_groupids_label
    ) {
      self$rfx_container_ptr <- rfx_container_from_json_string_cpp(
        json_string,
        json_rfx_container_label
      )
      ...
      self$training_group_ids <- rfx_group_ids_from_json_string_cpp(
        json_string,
        json_rfx_groupids_label
      )
    },
    ...
    #' @param json_rfx_groupids_label Label referring to a particular set of rfx group IDs (i.e. "random_effect_groupids_0") in the overall json hierarchy
    #' @return None
    append_from_json_string = function(
      json_string,
      json_rfx_container_label,
      json_rfx_mapper_label,
      json_rfx_groupids_label
      ...
      # Append RFX objects
      rfx_container_append_from_json_string_cpp(
        self$rfx_container_ptr,
        json_string,
        json_rfx_container_label
      )
    ...
    predict = function(rfx_group_ids, rfx_basis = NULL) {
      ...
      if (is.null(rfx_basis)) {
        rfx_basis <- matrix(rep(1, num_obs), ncol = 1)
      }
      num_samples = rfx_container_num_samples_cpp(self$rfx_container_ptr)
      num_components = rfx_container_num_components_cpp(
        self$rfx_container_ptr
      )
      ...
      output <- rfx_container_predict_cpp(
        self$rfx_container_ptr,
        rfx_dataset$data_ptr,
        self$label_mapper_ptr
      )
    ...
    extract_parameter_samples = function() {
      ...
      if (num_components == 1) {
        ...
        stop(
          "Invalid random effects sample container, num_components is less than 1"
        )
      }
...
RandomEffectsModel <- R6::R6Class(
  ...
  public = list(
    ...
    sample_random_effect = function(
      ...
      rfx_model_sample_random_effects_cpp(
        self$rfx_model_ptr,
        rfx_dataset$data_ptr,
        residual$data_ptr,
        rfx_tracker$rfx_tracker_ptr,
    ...
    set_working_parameter_cov = function(value) {
      ...
      rfx_model_set_working_parameter_covariance_cpp(
        self$rfx_model_ptr,
        value
      )
    },
    ...
    set_group_parameter_cov = function(value) {
      ...
      stopifnot(nrow(value) == self$num_components)
      stopifnot(ncol(value) == self$num_components)
      rfx_model_set_group_parameter_covariance_cpp(
        self$rfx_model_ptr,
        value
      )
    },
...
createRandomEffectSamples <- function(
  num_components,
  num_groups,
  random_effects_tracker
) {
