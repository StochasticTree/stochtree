...
class GaussianConstantLeafModel {
 public:
  ...
  void EvaluateAllPossibleSplits(ForestDataset& dataset, ForestTracker& tracker, ColumnVector& residual, TreePrior& tree_prior, double global_variance, int tree_num, int split_node_id, 
                                 std::vector<double>& log_cutpoint_evaluations, data_size_t& valid_cutpoint_count, int cutpoint_grid_size, data_size_t node_begin, data_size_t node_end, 
                                 std::vector<double>& variable_weights, std::vector<FeatureType>& feature_types);
