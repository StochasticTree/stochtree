...
Note that the nonlinearity of the ROC function means that the ROC curve of the posterior mean lies above most of the individual posterior sample ROC curves (which would not be the case if we had simply taken the mean of the ROC curves).
