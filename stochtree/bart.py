        ...
        **random_effects_params keys**
        ...
        if run_cpp:
          ...
          bart_config = {
              ...
              "sigma2_mean_init": sigma2_leaf if isinstance(sigma2_leaf, float) else -1.0,
              "sample_sigma2_leaf_mean": sample_sigma2_leaf,
              "mean_leaf_model_type": leaf_model_mean_forest,
              "sigma2_leaf_mean_matrix": sigma2_leaf.flatten(order="F") if isinstance(sigma2_leaf, np.ndarray) else None,
