        ...
        **random_effects_params keys**
        ...
        if run_cpp:
          ...
          bart_results = bart_sample_cpp(
              ...
              basis_dim = self.num_basis if self.has_basis else None,
              ...
              rfx_num_groups = num_rfx_groups if self.has_rfx else None,
              rfx_basis_dim = self.num_rfx_basis if self.has_rfx else None,
              num_gfr = num_gfr,
