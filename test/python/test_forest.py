...
class TestPredict:
    def test_constant_forest_construction(self):
        ...
        # Check that regular and "raw" predictions are the same (since the leaf is constant)
        pred = forest.predict(forest_dataset)
        pred_exp = np.array([-2.5,-7.5,-7.5,5.,5.,5.])
    ...
    def test_constant_forest_merge_arithmetic(self):
        ...
        pred_exp1 = np.array([0.,0.,0.,0.,0.,0.])
        pred_exp2 = np.array([0.,0.,0.,0.,0.,0.])
        ...
        pred1 = forest1.predict(forest_dataset)
        pred2 = forest2.predict(forest_dataset)
        pred_exp1 = np.array([-5.,-5.,-5.,5.,5.,5.])
        pred_exp2 = np.array([-1.,-1.,1.,1.,1.,1.])
        ...
        pred1 = forest1.predict(forest_dataset)
        pred2 = forest2.predict(forest_dataset)
        pred_exp1 = np.array([-2.5,-7.5,-7.5,5.,5.,5.])
        pred_exp2 = np.array([-0.5,-1.5,1.,1.,1.,1.])
        ...
        pred_exp = np.array([-0.5,-1.5,1.,1.,1.,1.])
