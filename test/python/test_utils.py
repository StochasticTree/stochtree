...
class TestUtils:
    ...
    def test_array_conversion(self):
        ...
        array_2d_1 = np.array([[2.5,1.2,4.3,7.4],[1.7,2.9,3.6,9.1],[7.2,4.5,6.7,1.4]])
        ...
        np.testing.assert_array_equal(np.column_stack((array_1d_3, array_1d_3, array_1d_3, array_1d_3)), _expand_dims_2d(array_1d_3, 1, 4))
        np.testing.assert_array_equal(np.vstack((array_1d_3, array_1d_3, array_1d_3, array_1d_3)), _expand_dims_2d(array_1d_3, 4, 1))
