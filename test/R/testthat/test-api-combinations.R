...
test_that("Quick check of interactions between components of BART functionality", {
  ...
  for (i in 1:nrow(model_options_df)) {
    ...
    if (error_cond || warning_cond) {
      # test_fun <- create_test_function(
      #   error_cond = FALSE,
      #   warning_conditions = c(warning_cond_1, warning_cond_2, warning_cond_3),
      #   warning_functions = c(warning_fun_1, warning_fun_2, warning_fun_3)
      # )
      # test_fun <- function(x) {
      #   result <- x
      #   if (warning_cond_1) {
      #     result <- warning_fun_3(result)
      #   }
      #   if (warning_cond_2) {
      #     result <- warning_fun_2(result)
      #   }
      #   if (warning_cond_3) {
      #     result <- warning_fun_1(result)
      #   }
      #   if (error_cond) {
      #     result <- expect_error(result)
      #   }
      # }
      # if (error_cond && warning_cond_1 && warning_cond_2 && warning_cond_3) {
      #   test_fun <- function(x) {
      #     expect_error(warning_fun_1(warning_fun_2(warning_fun_3(x))))
      #   }
      # } else if (
      #   error_cond && warning_cond_1 && warning_cond_2 && !warning_cond_3
      # ) {
      #   test_fun <- function(x) {
      #     expect_error(warning_fun_1(warning_fun_2(x)))
      #   }
      # } else if (
      #   error_cond && warning_cond_1 && !warning_cond_2 && warning_cond_3
      # ) {
      #   test_fun <- function(x) {
      #     expect_error(warning_fun_1(warning_fun_3(x)))
      #   }
      # } else if (
      #   error_cond && !warning_cond_1 && warning_cond_2 && warning_cond_3
      # ) {
      #   test_fun <- function(x) {
      #     expect_error(warning_fun_2(warning_fun_3(x)))
      #   }
      # } else if (
      #   error_cond && !warning_cond_1 && !warning_cond_2 && warning_cond_3
      # ) {
      #   test_fun <- function(x) {
      #     expect_error(warning_fun_3(x))
      #   }
      # } else if (
      #   error_cond && !warning_cond_1 && warning_cond_2 && !warning_cond_3
      # ) {
      #   test_fun <- function(x) {
      #     expect_error(warning_fun_2(x))
      #   }
      # } else if (
      #   error_cond && warning_cond_1 && !warning_cond_2 && !warning_cond_3
      # ) {
      #   test_fun <- function(x) {
      #     expect_error(warning_fun_1(x))
      #   }
      # } else if (
      #   error_cond && !warning_cond_1 && !warning_cond_2 && !warning_cond_3
      # ) {
      ...
      # ) {
      #   test_fun <- function(x) {
      #     warning_fun_1(warning_fun_2(warning_fun_3(x)))
      #   }
      # } else if (
      #   !error_cond && warning_cond_1 && warning_cond_2 && !warning_cond_3
      # ) {
      #   test_fun <- function(x) {
      #     warning_fun_1(warning_fun_2(x))
      #   }
      # } else if (
      #   !error_cond && warning_cond_1 && !warning_cond_2 && warning_cond_3
      # ) {
      #   test_fun <- function(x) {
      #     warning_fun_1(warning_fun_3(x))
      #   }
      # } else if (
      #   !error_cond && !warning_cond_1 && warning_cond_2 && warning_cond_3
      # ) {
      #   test_fun <- function(x) {
      #     warning_fun_2(warning_fun_3(x))
      #   }
      # } else if (
      #   !error_cond && !warning_cond_1 && !warning_cond_2 && warning_cond_3
      # ) {
