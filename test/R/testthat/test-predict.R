...
test_that("Predictions with pre-summarization", {
    ...
    y_hat_mean_test_single_term <- predict(het_bart_model, X_test, type = "mean", terms = "y_hat")
    sigma2_hat_mean_test_single_term <- predict(het_bart_model, X_test, type = "mean", terms = "variance_forest")
