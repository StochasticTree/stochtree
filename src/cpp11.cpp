...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_stochtree_run_bart_cpp",                                      (DL_FUNC) &_stochtree_run_bart_cpp,                                      24},
