...
system.time({
    ...
    bcf_model <- bcf(X_train = X_train, Z_train = Z_train, propensity_train = pi_train, 
                     y_train = y_train, X_test = X_test, Z_test = Z_test, 
                     propensity_test = pi_test, num_gfr = num_gfr, 
